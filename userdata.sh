...
CHEF_SERVER_NAME="Test-Chef-Automate" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="test-chef-automate-lg3omijxup4hjqdt.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
